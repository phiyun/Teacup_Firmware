...
Stepper -ENABLE xPWM   4 |b7     A11=* f6| 21 A7  PWM       Fan PWM                           	
        STEP X   PWM   5 |d0           f7| 20 A6  PWM       			 
         DIR X   PWM   6 |d1           b6| 19 A5            			 
        STEP Y         7 |d2           b5| 18 A4            			 
         DIR Y         8 |d3 V         b4| 17 A3            			 
        STEP Z   PWM   9 |d6 b 3 G P R d7| 16 A2            			 
         DIR Z   PWM  10 |d7 a V N G S d6| 15 A1            Bed TC                 	 
        STEP E        11 |d7 t 3 D M T d6| 14 A0            Extruder TC                  
...
/* teensy3 arduino assignments are 0-33 for digital, overlapping with A0=D14...A9=D23 

*/

/* starting down the left side for digital, and later down the right for analog */
/* General layout: ccw from upper left: stops,  X,Y,Z,E,  temp sensors, PWMs */
...
#define	Z_STEP_PIN						DIO9
#define	Z_DIR_PIN							DIO10
...
//#define	SD_CARD_DETECT		 		DIO4
//#define	SD_WRITE_PROTECT			DIO5
...
//            name      port   pwm
DEFINE_HEATER(extruder, DIO22, 1)
DEFINE_HEATER(bed,      DIO23,  1)
DEFINE_HEATER(fan,      DIO21,  1)
